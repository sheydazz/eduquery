...
const FormCreator = ({ onFormCreated }) => {
    ...
    return (
      <div className=' bottom-0 flex justify-center p-4 w-[100vw]'>
         <button onClick={handleCreateForm} className="bg-violet-700 m-[20px] border rounded-full w-[200px] h-[70px] text-white flex justify-center flex-wrap flex-row content-center text-2xl gap-[10px] sticky bottom-0 ">
