...
const FormCreator = ({ onFormCreated }) => {
  ...
  return (
    <div className="flex flex-col justify-center items-center p-4 w-full">
      {isLoading ? (
        <div role="status">
        <svg aria-hidden="true" className="inline w-14 h-14 text-gray-200 animate-spin dark:text-gray-600 fill-purple-600" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
